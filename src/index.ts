...
async function startAgent(character: Character, directClient: DirectClient) {
  try {
    ...
    await db.init();
    await db.query("CREATE TABLE IF NOT EXISTS therapy_states (room_id UUID, user_id UUID, status TEXT, present_symptoms TEXT[], relevant_history TEXT[], automatic_thoughts TEXT[], cognitive_distortions TEXT[], emotional_transitions TEXT[], proposed_treatment TEXT[], session_started_at TIMESTAMP, session_ended_at TIMESTAMP, PRIMARY KEY (room_id, user_id))");
